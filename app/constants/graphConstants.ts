...
export const primaryAxis: Axis = process.env.NEXT_PUBLIC_PRIMARY_AXIS as Axis;
export const secondaryAxis: Axis = process.env.NEXT_PUBLIC_SECONDARY_AXIS as Axis;
